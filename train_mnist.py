...
features,_ = network.inference(img_placeholder,is_training=phase_train_placeholder,bottleneck_layer_size=2)
...
with tf.Session() as sess:
    ...
    for step in range(total_steps + 1):
        ...
        if step%1000==0:
            ...
            test_features,acc=sess.run([features,accuracy],feed_dict={img_placeholder:images,label_placeholder:mnist.test.labels,phase_train_placeholder: False})
