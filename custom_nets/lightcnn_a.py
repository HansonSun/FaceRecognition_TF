...
def inference(image):
	with slim.arg_scope([slim.conv2d, slim.fully_connected],activation_fn=None,
		...
		#conv1
		net=slim.conv2d(image,96,[9,9],stride=1,scope="conv1",padding="VALID")
		#MFM1
		net=MFM(net)
		#pool1
		net=slim.max_pool2d(net,[2,2],stride=2,scope="pool1")
		#conv2
		net=slim.conv2d(net,192,[5,5],stride=1,scope="conv2",padding="VALID")
		#MFM2
		net=MFM(net)
		#pool2
		net=slim.max_pool2d(net,[2,2],stride=2,scope="pool2")
		#conv3
		net=slim.conv2d(net,256,[5,5],stride=1,scope="conv3",padding="VALID")
		#MFM3
		net=MFM(net)
		#pool3
		net=slim.max_pool2d(net,[2,2],stride=2,scope="pool3")
		#conv4
		net=slim.conv2d(net,384,[4,4],stride=1,scope="conv4",padding="VALID")
		#MFM4
		net=MFM(net)
		#pool4
