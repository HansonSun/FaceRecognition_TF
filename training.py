...
def training_test(total_loss, global_step, learning_rate, update_gradient_vars):
...
def run_training():
    ...
    train_op = training_test(total_loss,learning_rate,global_step,tf.global_variables())
