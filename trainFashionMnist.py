...
class MnistEval():
    def __init__(self):
        # Get MNIST Data
        self.fashoin_mnist = input_data.read_data_sets('classification_dataset/Fashion-MNIST/', one_hot=False)
    ...
    def process(self):
        ...
        with tf.Session() as sess:
            ...
            for step in range(self.total_steps + 1):
                images, labels = self.fashoin_mnist.train.next_batch(self.batch_size)
                ...
                if step%1000==0:
                    images=np.reshape(self.fashoin_mnist.test.images,(10000,28,28,1))
                    labels=self.fashoin_mnist.test.labels
                    total_acc=0
                    self.test_features=[]
    ...
    def draw_feature(self):
        ...
        tools_func.draw_features( self.test_features,self.fashoin_mnist.test.labels)
